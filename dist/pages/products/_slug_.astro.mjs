/* empty css                                              */
import { c as createComponent, i as createAstro, r as renderComponent, a as renderTemplate, m as maybeRenderHead, b as addAttribute } from '../../chunks/astro/server_Cm_g7ecK.mjs';
import 'kleur/colors';
...
const $$slug = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": product.name, "data-astro-cid-o422f4lv": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="py-20 bg-gradient-to-b from-blue-50 to-white animate-fadeIn" data-astro-cid-o422f4lv> <div class="container mx-auto px-4" data-astro-cid-o422f4lv> <div class="max-w-6xl mx-auto" data-astro-cid-o422f4lv> <!-- Back Button --> <a href="http://localhost:4321/network-cameras/WizMind-Series" class="inline-flex items-center mb-8 text-blue-600 hover:text-blue-700 group" data-astro-cid-o422f4lv> <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 transform group-hover:-translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-o422f4lv> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" data-astro-cid-o422f4lv></path> </svg> <span class="font-medium" data-astro-cid-o422f4lv>Back to Products</span> </a> <!-- Product Header --> <h1 class="text-5xl font-bold text-gray-900 mb-4 tracking-tight" data-astro-cid-o422f4lv>${product.id}</h1> <h2 class="text-4xl font-semibold text-gray-800 mb-6 leading-tight" data-astro-cid-o422f4lv>${product.name}</h2> <!-- Categories --> <div class="flex flex-wrap gap-3 mb-12" data-astro-cid-o422f4lv> <span class="px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium transition-all hover:scale-105 hover:shadow-md" data-astro-cid-o422f4lv> ${product.category} </span> <span class="px-4 py-2 bg-gray-50 text-gray-700 rounded-full text-sm font-medium transition-all hover:scale-105 hover:shadow-md" data-astro-cid-o422f4lv> ${product.subCategory} </span> </div> <!-- Product Content --> <div class="grid lg:grid-cols-2 gap-12 mb-12" data-astro-cid-o422f4lv> <!-- Image Gallery --> <div class="space-y-6" data-astro-cid-o422f4lv> <div class="rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 bg-white mt-10" data-astro-cid-o422f4lv> <img${addAttribute(product.image, "src")}${addAttribute(product.name, "alt")} class="w-full h-[400px] object-contain transform hover:scale-105 transition-all duration-500" data-astro-cid-o422f4lv> </div> <div class="rounded-xl overflow-hidden" data-astro-cid-o422f4lv> <img${addAttribute(product.additionalImage, "src")} alt="Additional Product View" class="w-full h-[200px] object-contain" data-astro-cid-o422f4lv> </div> </div> <!-- Product Description --> <div class="space-y-6 p-6 rounded-2xl " data-astro-cid-o422f4lv> <h3 class="text-2xl font-bold text-gray-900 mb-4" data-astro-cid-o422f4lv>Product Specifications</h3> <div class="space-y-3" data-astro-cid-o422f4lv> ${product.description.split("\n").filter((line) => line.trim()).map((line) => renderTemplate`<div class="flex items-start group" data-astro-cid-o422f4lv> <span class="inline-block w-2 h-2 rounded-full bg-blue-500 mt-2.5 mr-3 group-hover:scale-110 transition-transform" data-astro-cid-o422f4lv></span> <p class="text-gray-700 text-lg leading-relaxed group-hover:text-gray-900 transition-colors" data-astro-cid-o422f4lv> ${line.replace("\u2022", "").trim()} </p> </div>`)} </div> </div> </div> </div> </div></section>  <div class="flex items-center justify-center my-16" data-astro-cid-o422f4lv> <a${addAttribute(product.brochure, "href")} download="product-brochure.pdf" class="group inline-flex items-center px-8 py-4 text-lg font-medium text-white 
               ...
               animate-glow" data-astro-cid-o422f4lv> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 transform group-hover:-translate-y-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-astro-cid-o422f4lv> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" data-astro-cid-o422f4lv></path> </svg> <span class="relative group-hover:-translate-y-1 transition-transform duration-300" data-astro-cid-o422f4lv>
Download Brochure
</span> </a> </div> ` })} `;
}, "C:/Users/Adeeb/Downloads/dahua-2025-main/dahua-2025-main/src/pages/products/[slug].astro", void 0);

const $$file = "C:/Users/Adeeb/Downloads/dahua-2025-main/dahua-2025-main/src/pages/products/[slug].astro";
